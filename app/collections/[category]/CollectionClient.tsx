...
export default function CollectionClient({ category }: { category: string }) {
  ...
  const FilterSection = ({ title, options, category }: { title: string; options: FilterOption[]; category: string }) => (
